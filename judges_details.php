...
// Fetch data from 'regform1' table
$sql = "SELECT * FROM `regform1`";
$Sql_query = mysqli_query($conn, $sql);
$All_judges = mysqli_fetch_all($Sql_query, MYSQLI_ASSOC);

// Fetch data from 'regform2' table
$sql = "SELECT * FROM `regform2`";
$Sql_query = mysqli_query($conn, $sql);
$All_judge = mysqli_fetch_all($Sql_query, MYSQLI_ASSOC);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // SQL query to insert data into the 'judges' table
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo '<div class="alert alert-danger" role="alert">Registration unsuccessful, please try again</div>';
    }
}
?>
...
<div class="container my-4" style="background-color:#f3f6fc; padding: 2em; border-radius: 5px;">
    ...
    <div class="container my-4" style="background-color:#f3f6fc; padding: 2em; border-radius: 5px;">
      <table class="table" id="tbl">
        ...
        <tbody>
          <?php
          foreach ($All_judges as $regform1) {
          ?>
            <tr>
              <td><?php echo $regform1['id']; ?></td>
              <td><?php echo $regform1['fname']; ?></td>
            </tr>
          <?php
          }

          foreach ($All_judge as $regform2) {
          ?>
            <tr>
              <td><?php echo $regform2['id']; ?></td>
              <td><?php echo $regform2['fname']; ?></td>
              <td><?php echo $regform2['image1']; ?></td>
            </tr>
          <?php
          }
          ?>
...
//       <td>$row[Password]</td>
//       <td>
//       <a href='judge_delete.php?id=".$row['Id']."' class='btn btn-primary btn-sm' >Delete</td>
...
//     }
    ...
    //    <td>" . $row[3] . "</td>
    //    <td>
    //    <a class='btn btn-primary btn-sm' href=delete.php?id=$row[0]' name='h'>Delete</td>
    //     </tr>
    //    ";
    // }
  -->
